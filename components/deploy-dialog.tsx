    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="default">
          <Logo style={{ color: 'e2b' }} width={16} height={16} className="mr-2" />
          Deploy to E2B
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent className="p-4 w-80 flex flex-col gap-2">
        <div className="text-sm font-semibold">Nasadit na E2B</div>
        <div className="text-sm text-muted-foreground">
          Nasazením fragmentu ho zpřístupníte ostatním prostřednictvím odkazu.
        </div>
        <div className="text-sm text-muted-foreground">
